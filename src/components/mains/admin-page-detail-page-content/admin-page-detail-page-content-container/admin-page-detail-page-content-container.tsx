...
export default function AdminPageDetailPageContentContainer({
  currentPageData,
  userData,
  ...
  // const [destinations, setDestinations] = useState<string[]>(currentPageData.destinations);
              ...
              <Grid>
                <GridCol span={6}>
                  <Stack gap={'xs'}>
                    ...
                    }} value={currentPageData.country} disabled />
                  </Stack>
                </GridCol>
                <GridCol span={6}>
                  <Stack gap={'xs'}>
