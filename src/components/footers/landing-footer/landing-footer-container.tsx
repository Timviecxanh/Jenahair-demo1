      ...
      <div className={classes.top}>
        <Container size="xl" classNames={{ root: classes.footerContainer }}>
          <Grid classNames={{
            ...
            >
              <Text fz={'h2'} c={'white'} className={classes.footerTitle}>Smash Travel Vietnam</Text>
              ...
              <Group className={classes.footerLinks} gap={'xl'}>
                <Group className={classes.socials} gap={'md'}>
                  <Link href="https://www.facebook.com/smashtravelvietnam/" target="_blank" rel="noopener noreferrer" aria-label="Visit our Facebook page">
