  ...
  return (
    <Grid classNames={{
        ...
        <Stack justify="space-between" align="stretch" h={612}>
          <Grid>
            <GridCol span={6} h={500}>
              <ImageCard imageUrl={'/images/ha-noi-sample.jpg'} title="Ha Noi" />
            </GridCol>
            <GridCol span={6} h={500}>
              <ImageCard imageUrl={'/images/khanh-hoa-sample.jpg'} title="Khanh Hoa" />
            </GridCol>
          </Grid>
          <Group
            wrap="nowrap"
      ...
      <GridCol span={{ base: 12, sm: 6, md: 6, lg: 6 }}>
        <Stack h={612}>
          <ImageCard imageUrl={'/images/da-lat-sample.jpg'} title="Da Lat" />
          <ImageCard imageUrl={'/images/phu-quoc-sample.jpg'} title="Phu Quoc" />
        </Stack>
      </GridCol>
    </Grid>
  )
